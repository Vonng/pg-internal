...
> | :-------: | :----: | :--------: | :------------------------------: | :--------: |
> | 读已提交  | 不可能 |    可能    |               可能               |    可能    |
> | 可重复读* | 不可能 |   不可能   | PG中不可能<br />但ANSI SQL中可能 |    可能    |
> | 可序列化  | 不可能 |   不可能   |              不可能              |   不可能   |
>
> 在9.0及更早版本中，此级别被当做`SERIALIZABLE`，因为它不会出现ANSI SQL-92标准中定义的三种异常。 但随着9.1版中SSI的实现，该级别已被改称为`REPEATABLE READ`，并引入了真正的`SERIALIZABLE`级别。
